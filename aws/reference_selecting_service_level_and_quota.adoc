...
+
If your application has a balanced need for storage capacity and bandwidth, then the Premium service level might be most appropriate for you.  This level is less expensive per MB/s than the Standard service level, and it is also less expensive per GB of storage capacity then the Extreme service level.
+
...
Quotas are specified in GBs.  A volume's quota can be set within the range of 1 GB to 100,000 GB (equivalent 100 TBs).
...
For example, your application needs 25 TB of capacity and 100 MB/s of bandwidth. At 25 TB of capacity, the Standard service level would provide 391 MB/s of bandwidth at a cost of $3,750, making Standard the most suitable service level.
